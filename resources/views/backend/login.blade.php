...
<head>
    ...
    <link rel="stylesheet" href="{{asset('backend/dist')}}/assets/css/pages/auth.css">
</head>
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="index.html"><img src="{{asset('backend/dist')}}/assets/images/logo/logo.png" alt="Logo"></a>
                    </div>
